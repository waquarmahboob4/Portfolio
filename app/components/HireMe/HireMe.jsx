  ...
  return (
    ...
    sm:right-0">
      <div className="w-48 h-auto flex items-center justify-center relative md:w-24">
        ...
        <Link href="mailto:waquarmahboob4@gmail.com" className="flex items-center justify-center absolute left-1/2
        top-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark text-light shadow-md border border-solid border-dark w-20 h-20 rounded-full
        ...
        md:w-12 md:h-12 md:text-[10px] md:z-10">
            Hire Me
        </Link>
      </div>
    </div>
